...
/* harmony export */   "associateAccordionWithImageSrc": () => (/* binding */ associateAccordionWithImageSrc),
/* harmony export */   "iniMiniPartnersSwiper": () => (/* binding */ iniMiniPartnersSwiper),
/* harmony export */   "initAccordion": () => (/* binding */ initAccordion),
/* harmony export */   "initLangSelects": () => (/* binding */ initLangSelects)
/* harmony export */ });
...
function iniMiniPartnersSwiper() {
  return new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".mini-partners__slider", {
...
function initAccordion() {
  ...
  accCol.forEach(function (acc) {
    var accItemCol = acc.querySelectorAll(".acc__item");
    {
      var firstAccItem = accItemCol[0];
      firstAccItem.classList.add("acc__item_active");
      var firstAccPanel = firstAccItem.querySelector(".acc__panel");
      firstAccPanel.style.maxHeight = firstAccPanel.scrollHeight + 32 + "px";
    }
    accItemCol.forEach(function (accItem) {
      var accBtn = accItem.querySelector(".acc__btn");
      var accPanel = accItem.querySelector(".acc__panel");
      accBtn.addEventListener("click", function () {
        accItemCol.forEach(function (otherAccItem) {
          var otherActiveAccItem = otherAccItem.classList.contains("acc__item_active");
          if (accItem === otherAccItem || !otherActiveAccItem) return;
          var otherAccPanel = otherAccItem.querySelector(".acc__panel");
...
function associateAccordionWithImageSrc() {
  var acc = document.querySelector(".about-accordeon__acc");
  var image = document.querySelector(".about-accordeon__img");
  var accItemCol = acc.querySelectorAll(".acc__item");
  {
    var firstAccItem = accItemCol[0];
...
function initLangSelects() {
  document.querySelectorAll(".select-lang").forEach(function (choicesEl) {
    var choice = new choices_js__WEBPACK_IMPORTED_MODULE_1__(choicesEl, {
      searchEnabled: false,
      position: "bottom",
      itemSelectText: "",
      shouldSort: false,
...
(0,_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.iniMiniPartnersSwiper)();
(0,_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.initAccordion)();
(0,_modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.associateAccordionWithImageSrc)();
// initLangSelects();
