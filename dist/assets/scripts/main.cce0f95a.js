...
function initLangChoices() {
  var classBlock = classNames.choices.block;
  document.querySelectorAll(".".concat(classBlock)).forEach(function (choicesEl) {
...
function initRateSwiper() {
  var _breakpoints2;
  var classBlock = classNames.swiper.rateSlider;
  return new core(".".concat(classBlock), {
